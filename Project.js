    ...
    // expectations vs reality 
        ...
        if (realBalance == 0) {
            return function(name) {
                console.log(name + ' , you spent way too much this month. You have no balance left.')
            }} else if (realBalance < 0) {
                return function(name) {
                console.log(name + ' , you spent way too much. You are now in debt. ')
            }} else if (realBalance <= expectedBalance) {
                return function(name) {
            console.log(name + ', you only have ' + realBalance + ' left, you are spending over your limit this month.');
        }
    }  else if (realBalance >= expectedBalance + 1 && realBalance < expectedBalance + (0.30 * expectedBalance) ) {
        return function(name) {
            console.log('Good job ' + name + ', you still have ' + realBalance + ' you are spending within your limit this month');
        }
    } else { 
    return function(name) {
        console.log(name + ' , you still have ' + realBalance + ' you are being very frugal with your spending. You will be rewarded next month!');
    }}};
...
// function for removing that item in the wish list when you have already purchased it 
// also planning to implement a drop-down menu for birthday and gender 
/*
